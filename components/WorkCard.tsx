...
export default function WorkCard({ work, filters }: WorkCardProps) {
  ...
  return (
    <li>
      <a
        href={`/works/${title}`}
        class='block relative w-full h-full min-h-80 rounded-2xl overflow-hidden cursor-pointer hover:scale-105 duration-300 bg-surface-variant text-on-surface-variant dark:bg-surface-variant-dark dark:text-on-surface-variant-dark'
      >
        <img
